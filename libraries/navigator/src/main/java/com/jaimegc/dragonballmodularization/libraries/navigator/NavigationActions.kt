...
object NavigationActions {
    ...
    fun navigateToHomeScreen(context: Context, noAnimation: Boolean = true) =
        internalIntent(context, "com.dragonballmodularization.features.home.navigate", noAnimation).also {
            navigate(context, it)
        }

    fun navigateToDragonBallDetailsScreen(context: Context, dragonBallId: Long, noAnimation: Boolean = true) =
